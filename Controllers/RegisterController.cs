    ...
    public class RegisterController : ControllerBase
    {
        ...
        public async Task<ActionResult<CustomerHelper>> Index(CustomerHelper helper)
        {
            ...
            if (already == null)
            {
                ...
                Customer.Firstname = helper.firstname;
                Customer.Lastname = helper.lastname;
                Customer.Email = helper.email;
                Customer.Hash = hashSalt.Hash;
                Customer.Salt = hashSalt.Salt;
                Customer = await dao.Register(Customer);
                if (Customer.Id > 0)
